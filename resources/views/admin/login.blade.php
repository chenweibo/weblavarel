				...
				<div class="col-sm-5">
					<form method="post" action="index.html">
						...
						<div style="margin-bottom:70px">
							<input type="text" class="form-control" placeholder="验证码" style="color:black;width:120px;float:left;margin:0px 0px;" name="captcha" id="code" />
							<img id="imgcode" src="{{captcha_src('default')}}" onclick="javascript:this.src='{{captcha_src('default')}}?default='+Math.random();" style="float:right;cursor: pointer" />
