    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <a href="{{route('AritcleCreate',['pid'=>$id])}}" class="btn btn-primary">添加</a>
                <a href="#" onclick="javascript:Del(arr,'{{route("AritcleMoreDelete")}}')"
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="#" onclick="movefile(arr,3)">移动</a>
                        </li>
                        <li><a href="#" onclick="copyfile(arr,3)">复制</a>
                        </li>
                    </ul>
                </div>

                <div class="admin_search row" style=" height:35px; float:right">
                    <form class="navbar-form navbar-left zz" action="{{route('Aritcle')}}" method="get" role="search">
                        ...
                        <table class="layui-table">
                            ...
                            @foreach ($list as $v)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('AritcleEdit',['id'=>$v->id])}}"
                                           class="layui-btn  layui-btn-small">编辑</a>
                                        <a href="javascript:Del({{$v->id}},'{{route("AritcleDelete")}}')"
