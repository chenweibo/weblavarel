                            ...
                            <tbody>
                             @foreach ($list as $v)
                                <tr >
                                    ...
                                    <td>
                                      <a href="javascript:RecycleRecover({{$v->id}},'{{route("RecycleRecover")}}')"
                                         class="layui-btn  layui-btn-small">恢复</a>
                                      <a href="javascript:Del({{$v->id}},'{{route("RecycleDelete")}}')"
                                         class="layui-btn layui-btn-danger layui-btn-small dc">彻底删除</a>
                                    </td>
                                </tr>
                              @endforeach
                            </tbody>
