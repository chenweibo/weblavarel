                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="commentForm" method="post" onsubmit="return toVaild()">
                                ...
                                <div class="input-group col-sm-4">
                                    <select class="form-control" name="typeid" required="" aria-required="true">
                                        ...
                                        @if (!empty($role))
                                            @foreach ($role as $key )
                                                <option value="{{$key->id}}"
                                                        @if ($key->id == $data->typeid) selected @endif>{{$key->rolename}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-4">
                                    <input id="password" type="text" class="form-control" placeholder="再次输入修改密码"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-4">
                                    <input id="real_name" type="text" class="form-control" name="real_name"
                                           value="{{$data->real_name}}" required="" aria-required="true">
